...
names(hale3)
set.seed(123)
train       <- sample(1:nrow(hale3[, -c(1:5,29,30,39:42)]), size = nrow(hale3)/2)
datos_train <- hale3[, -c(1:5,29,30,39:42)][train,]
datos_test  <- hale3[, -c(1:5,29,30,39:42)][-train,]
...
print(modelo.rf)
capture.output(modelo.rf, file="RF_hale3.doc")
